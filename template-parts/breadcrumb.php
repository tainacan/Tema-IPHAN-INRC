...
function custom_breadcrumbs()
{
    ...
    $home = __('Início', 'iphan-inrc'); // text for the 'Home' link
    ...
    if (is_front_page()) {
        ...
        if (is_category()) {
            ...
            echo $before . __('Listagem da categoria  "', 'iphan-inrc') . single_cat_title('', false) . '"' . $after;
        } elseif (is_search()) {
            echo $before . __('Resultados de busca para "', 'iphan-inrc') . get_search_query() . '"' . $after;
        } elseif (is_day()) {
            ...
            echo $before . __('Publicações marcadas "', 'iphan-inrc') . single_tag_title('', false) . '"' . $after;
        } elseif (is_author()) {
            global $author;
            $userdata = get_userdata($author);
            echo $before . __('Artigos publicados por ', 'iphan-inrc') . $userdata->display_name . $after;
        } elseif (is_404()) {
            echo $before . __('Erro 404', 'iphan-inrc') . $after;
        }
