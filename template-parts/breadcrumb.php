...
function custom_breadcrumbs()
{
	...
	if (is_home() || is_front_page()) {
		...
		if ($showOnHome == 1) echo '<nav aria-label="breadcrumb" class="breadcrumb  container d-none d-md-flex border-bottom-0 max-large margin-one-column"><a href="' . $homeLink . '">' . $home . '</a></nav>';

	} else {

		echo '<nav aria-label="breadcrumb" class="breadcrumb d-md-flex border-bottom-0 max-large margin-one-column"><a href="' . $homeLink . '">' . $home . '</a>&nbsp;' . $delimiter . '&nbsp;';
