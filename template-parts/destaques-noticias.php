<section class="destaques-noticias">
    ...
    <div class="div-destaques-noticias grid-container-noticias  col-md-12 is-desktop">
        ...
        ?>
            <a class="display-<?php echo $i + 1 ?>-noticias" href="<?php echo get_post_permalink($results[$i]->ID) ?>" style="background-image: url(' <?php echo get_the_post_thumbnail_url($results[$i]->ID) ?>')">
