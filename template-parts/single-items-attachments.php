...
$is_gallery_mode            = true; //get_theme_mod( 'iphan_inrc_document_attachments_structure', 'gallery-type-1' ) == 'gallery-type-2';
$hide_file_name             = true; //get_theme_mod( 'iphan_inrc_hide_files_name', 'no') == 'yes';
$hide_file_name_main        = false; //get_theme_mod( 'iphan_inrc_hide_files_name_main', 'yes') == 'yes';
$hide_file_caption_main     = true; //get_theme_mod( 'iphan_inrc_hide_files_caption_main', 'yes') == 'yes';
$hide_file_description_main = true; //get_theme_mod( 'iphan_inrc_hide_files_description_main', 'yes') == 'yes';
$hide_download_button       = false; //get_theme_mod( 'iphan_inrc_hide_download_button', 'no' ) == 'yes';
global $post;
if (function_exists('tainacan_the_media_component') && (!empty($attachments) || ($is_gallery_mode && tainacan_has_document()))) {
?>
    <section class="tainacan-content tainacan-item-section tainacan-item-section--<?php echo ((!$is_gallery_mode ? 'attachments' : 'gallery')) ?>">
        <?php if ((get_theme_mod('iphan_inrc_display_section_labels', 'yes') == 'yes') && (!$is_gallery_mode) && get_theme_mod('iphan_inrc_section_attachments_label', __('Attachments', 'blocksy-tainacan')) != '') : ?>
            <h2 class="tainacan-single-item-section" id="tainacan-item-attachments-label">
                <?php echo esc_html(get_theme_mod('iphan_inrc_section_attachments_label', __('Attachments', 'blocksy-tainacan'))); ?>
            </h2>
        <?php endif; ?>
        <?php if ((get_theme_mod('iphan_inrc_display_section_labels', 'yes') == 'yes') && ($is_gallery_mode) && get_theme_mod('iphan_inrc_section_documents_label', __('Documents', 'blocksy-tainacan')) != '') : ?>
            <h2 class="tainacan-single-item-section" id="tainacan-item-documents-label">
                <?php echo esc_html(get_theme_mod('iphan_inrc_section_documents_label', __('Documents', 'blocksy-tainacan'))); ?>
            </h2>
        <?php endif; ?>
        <?php
