    ...
    'iphan/card-block-iphan',
    {
        ...
        edit: function (props) {
            ...
            return (/* el(
                ...
                <div {...blockProps}>
                    <h1 onChange:updateTitle placeholder="Insira o título" style=" height: 100px" className="is-style-title-iphan-underscore" >{attributes.title}</h1>
                    <p onChange:updateContent placeholder="Insira o conteúdo" className="content-card-iphan" >{attributes.content}</p>
                    <div>
                        <InnerBlocks />
                    </div>
                </div >)
